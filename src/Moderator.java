...
public class Moderator extends Person{
	...
	public Moderator(String username, String primaryEmail,
			...
			String lastName, String address, String aboutMe, String[] photoURL,
			long regTime, String userType, String qualification,
			String contactNo) {
	...
	public void displayDetails()
	{
		...
		System.out.print("\nQualification Details - " + this.qualification + "  ----(Press 10 to update)");
	}
	...
	public void updateDetails(int selection)
	{
		...
		switch(selection)
		{
			...
			case 10: System.out.println("Update Qualification.: ");
